            ...
            <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
              ...
              <div className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <form className="mt-10">
                  ...
                  <div className="mt-10">
                    <div className="">
                      ...
                      <div className="flex items-center justify-evenly mt-3">
                        <div className="flex justify-center items-center rounded-full  p-2 px-5 border border-transparent bg-blue-900  text-2xl font-bold text-white hover:bg-blue-800">
                          <button onClick={handleOnDecrease} className="   ">
                            -
                          </button>
                        </div>
                        ...
                        <div className="flex justify-center items-center rounded-full  p-2 px-4 border border-transparent bg-blue-900  text-2xl font-bold text-white hover:bg-blue-800 ">
                          <button onClick={handleOnIncrease} className="  ">
                            +
                          </button>
                        </div>
                      </div>
                  ...
                  <button
                    className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-blue-900 px-8 py-3 text-base font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:ring-offset-2"
