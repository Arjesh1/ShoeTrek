...
const ReviewFormsModal = ({orderDetails}) => {
            ...
            <label  className="block text-sm font-medium leading-6 text-gray-900">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-2 sm:border-0 pl-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
