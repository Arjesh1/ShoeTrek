    ...
    <div className="flex flex-col  items-center justify-center sm:items-stretch sm:justify-start ">
                ...
                <div className="mt-2">
                  <ul className="flex justify-center gap-5 text-2xl">
                    <li className='text-gray-400 hover:text-white'><Link to="/"><BsFacebook/></Link></li>
                    <li className='text-gray-400 hover:text-white'><Link to="/"><BsInstagram/></Link></li>
                    <li className='text-gray-400 hover:text-white'><Link to="/"><BsTwitter/></Link></li>
                    <li className='text-gray-400 hover:text-white'><Link to="/"><BsYoutube/></Link></li>
                  </ul>
                </div>
...
<div className="container mx-auto">
  <hr/>
  <p className='py-1 text-center'>© 2023 Shoe Trek. All rights reserved.</p>
</div>
     </Disclosure>
