          ...
          <div className="flex flex-col sm:flex-row justify-evenly w-screen gap-4 gap-y-6">
            ...
            <div className="max-w-xl w-full lg:max-w-lg">
              <div className="mt-6 flex max-w-md gap-x-4">
                ...
                <button
                  type="submit"
                  className="flex-none rounded-md bg-blue-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                >
                  Subscribe
                </button>
              </div>
