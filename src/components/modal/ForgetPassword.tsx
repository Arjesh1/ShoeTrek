    ...
    <>
      <Transition.Root show={forgetPassword} as={Fragment}>
        <Dialog
          ...
          onClose={() => dispatch(setForgetPassword(false))}
        >
          <Transition.Child
            as={Fragment}
                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              ...
                              password? You will receive an link to reset your
                              password on your nominated email.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className=" mt-4  ">
                        <div className="w-full col-span-full">
                          <label
                            htmlFor="email"
                            className=" w-auto flex justify-center text-center  text-sm font-medium leading-6 text-gray-900"
                          >
                            Email address
                          </label>
                          <div className="mt-2 w-full">
                            <input
                              ...
                              className=" w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-900 sm:text-sm sm:leading-6"
                            />
                          </div>
                        </div>
                      </div>
